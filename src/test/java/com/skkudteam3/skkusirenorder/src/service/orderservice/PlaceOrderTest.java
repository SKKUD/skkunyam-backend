package com.skkudteam3.skkusirenorder.src.service.orderservice;
...
import com.skkudteam3.skkusirenorder.src.dto.OrderPostResDTO;
...
public class PlaceOrderTest {
    ...
    @Test
    public void placeOrderTest_default() throws Exception{
        //given
        ...
        //when
        OrderPostResDTO orderPostResDTO = orderService.placeOrder(orderPostReqDTO);

        // then
        System.out.println("주문ID : " + orderPostResDTO.getOrderId() + "\n주문번호 : " + orderPostResDTO.getOrderNumber() + "\n주문 가격 : " + orderPostResDTO.getTotalPrice());
    }
