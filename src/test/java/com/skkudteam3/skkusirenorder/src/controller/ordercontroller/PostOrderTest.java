...
public class PostOrderTest {
    ...
    @Test
    public void postOrderTest_default() throws Exception{
        //given
        ...
        String param = objectMapper.writeValueAsString(orderPostReqDTO);

        Cafeteria cafeteria = cafeteriaService.findCafeteria(1L);
        log.info("가게개장 상태 = {}", cafeteria.getIsCafeteriaOpen());
