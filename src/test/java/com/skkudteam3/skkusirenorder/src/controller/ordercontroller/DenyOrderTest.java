...
public class DenyOrderTest {
    ...
    public void payOrderTest_default() throws Exception {
        ...
        String param = objectMapper.writeValueAsString(orderDenyReqDTO);
        //when
        mockMvc.perform(patch("/order/deny")
        ...
        Assert.assertEquals(order.getOrderCancellationMessage(), orderDenyReqDTO.getOrderCancellationMessage());
    }
}
